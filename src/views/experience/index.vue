<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="用户名" width="150" prop="nickName"></el-table-column>
      <el-table-column label="用户头像" width="120" align="center">
        <template slot-scope="scope">
          <img :src="scope.row.avatarUrl" style="height:75px;width:100px;">
        </template>
      </el-table-column>
      <el-table-column label="心得体会" prop="content" min-width="200px" show-overflow-tooltip></el-table-column>
...
<script>
import { findAllExperience } from "@/api/article";
...
export default {
  ...
  methods: {
    ...
    refreshData() {
      this.loading = true;
      findAllExperience({ page: this.page, pageSize: this.pageSize })
        .then(res => {
          this.loading = false;
          this.pageData = res;
          this.data = res.data;
